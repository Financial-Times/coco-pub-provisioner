...
#to validate methode articles' internal components are valid for publication
...
#to validate wordpress articles are valid for publication
#the corresponding delivery cluster wa mapper url for a given publish cluster.
